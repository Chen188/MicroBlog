...
namespace 微博舆论.Setting
{
    ...
    public class PanGuSettings
    {
        ...
        private Match.MatchOptions _MatchOptions = new 微博舆论.Match.MatchOptions();
        ...
        private Match.MatchParameter _Parameters = new 微博舆论.Match.MatchParameter();
        ...
        {
            Match.MatchOptions options = new 微博舆论.Match.MatchOptions();
        ...
        {
            Match.MatchParameter parameter = new 微博舆论.Match.MatchParameter();
