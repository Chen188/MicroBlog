    ...
    //@"[０-９\d]+|[^ａ-ｚＡ-Ｚa-zA-Z0-9０-９\u4e00-\u9fa5]|[ａ-ｚＡ-Ｚa-zA-Z]+|[\u4e00-\u9fa5]+";
        ...
        private bool MergeEnglishSpecialWord(string orginalText, SuperLinkedList<WordInfo> wordInfoList, ref SuperLinkedListNode<WordInfo> current)
        {
            ...
            if (last >= 0)
            {
                ...
                WordInfo newWordInfo = new WordInfo(new 微博舆论.Dict.PositionLength(first, last - first, 
        ...
        private SuperLinkedList<WordInfo> GetInitSegment(string text)
        {
            ...
            Framework.Lexical lexical = new 微博舆论.Framework.Lexical(text);
            ...
            while (cur != null)
            {
                ...
                switch (cur.Value.WordType)
                {
                    case WordType.SimplifiedChinese:
                        ...
                        微博舆论.Framework.AppendList<Dict.PositionLength> pls = _WordDictionary.GetAllMatchs(inputText, _Options.ChineseNameIdentify);
                        微博舆论.Match.ChsFullTextMatch chsMatch = new 微博舆论.Match.ChsFullTextMatch(_WordDictionary);
        ...
        static private void LoadDictionary()
        {
            ...
            _DictLoader = new 微博舆论.Dict.DictionaryLoader(Setting.PanGuSettings.Config.GetDictionaryPath());
        }
        ...
        private static void InitInfinitiveVerbTable()
        {
            ...
            using (System.IO.StringReader sr = new System.IO.StringReader(Seq.StringRes.INFINITIVE))
            {
