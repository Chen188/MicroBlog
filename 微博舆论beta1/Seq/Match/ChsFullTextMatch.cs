...
namespace 微博舆论.Match
{
    public class ChsFullTextMatch: IChsFullTextMatch
    {
        ...
        Framework.AppendList<Node> _LeafNodeList = new 微博舆论.Framework.AppendList<Node>();
        Dict.PositionLength[] _PositionLengthArr;
        int _InputStringLength;
        int _PositionLengthArrCount;

        List<Dict.PositionLength[]> _AllCombinations = new List<微博舆论.Dict.PositionLength[]>();
        ...
        {
            LinkedList<Dict.PositionLength> result = new LinkedList<微博舆论.Dict.PositionLength>();
        ...
        /// <returns></returns>
        private Node[] GetLeafNodeArrayCore(微博舆论.Dict.PositionLength[] positionLenArr, int orginalTextLength, int count)
        {
            _LeafNodeList.Clear();
